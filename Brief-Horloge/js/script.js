...
function demarrerLaMontre() { 
    setInterval(
        ...
        //inversion pour que l'aiguille tourne dans l'autre sens
        seconde= - (temps.getSeconds());
        //pour éviter de faire deux tours lors de l'initialisation si PM
        if (heure>=12)[heure=heure-12];
        

let degSeconde = (seconde*6);
// Comment éviter que l'aiguille ne change d'avis ?
